...
import time
import sys
# sys.path.append(r'D:\Documents\中科大\DMM6500 型数字万用表\Keithley_DMM6500_Drivers-master\02_Keithley_DMM6500_Python_VISA_Driver_Win10')
...
np.save(r"C:\Users\mantoutou\OneDrive\文档\中科大\超导量子计算科研\实验\Z板子噪声室温测试\DMM测试数据\广州号\EZQ2_4通道_输出0.6123_RT10dB_3.npy", 
        M_dict_lists)
print("save .npy done")
#%% 数据处理
# dt = 1/48
...
Data_all = np.load(r"C:\Users\mantoutou\OneDrive\文档\中科大\超导量子计算科研\实验\Z板子噪声室温测试\DMM测试数据\Hefei_F111_6+\TEST.npy",
